...
// A hacky shell script to ensure the /lib/upgrade/common.sh file
// is updated to not kill spid and usbexecd when executing sysupgrade
module.exports.updateUpgradeScript = function() {
  return ['sed', '-i', `/\*procd\*\|\*ash\*\|\*init\*\|\*watchdog\*\|\*ssh\*\|\*dropb
ear\*\|\*telnet\*\|\*login\*\|\*hostapd\*\|\*wpa_supplicant\*\|\*nas\*/c \*procd
*|*ash*|*init*|*watchdog*|*ssh*|*dropbear*|*telnet*|*login*|*hostapd*|*wpa_suppl
icant*|*nas*|*spid*|*usbexecd*) : ;;\'`, '/lib/upgrade/common.sh'];
}
